...
- Rust workspace lint/format/docs: `cd rust && cargo fmt --all -- --check && cargo clippy --workspace --locked --all-targets --all-features -- -D warnings && RUSTDOCFLAGS="-D warnings" cargo doc --workspace --no-deps`
